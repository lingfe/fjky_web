	...
	<view class='content'>
		...
		<view>
			...
			<view class='list'>
				<text>结束时间</text>
				<view class="uni-list-cell-db">
					<picker mode="date" :value="date1" :start="endDate" :end="endDate" @change="bindDateChange1">
						<view class='chiceTime'>
		...
		<view @click="saveData()" class='saveBtn'>
			<text>保存</text>
		</view>
	</view>
</template>
