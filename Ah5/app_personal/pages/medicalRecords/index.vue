		...
		<view>
			<view class='item' v-for='(item,index) in items' :v-key='index'>
				...
				<view>
					...
					<!-- 结果分析 -->
					<view class='result_'>
						就诊原因:个人生活习惯问题导致的一些肺病肝病,注意下生活习惯,保持健康生活方式和积极向上的心态将能减轻疾病的症状和提高药效.
					</view>
					<text class='showDetail' @click="detailmedicalRecords()">查看详情</text>
				</view>
			</view>
		</view>
	</view>
...
<script>
	...
	export default {
		...
		methods: {
			...
			addmedicalRecords(){
				goto.goto('../addmedicalRecords/index');
			},
			detailmedicalRecords(){
				goto.goto('../detailmedicalRecords/index');
			}
		},
	}
</script>
